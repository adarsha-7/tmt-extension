...
function drawOverlays(imgEl, lines) {
  ...
  dismissBtn.style.cssText = "position:absolute;top:6px;right:6px;z-index:10000;background:rgba(0,0,0,0.7);color:white;border:none;border-radius:4px;padding:3px 8px;font-size:11px;cursor:pointer;font-family:sans-serif";
...
function removeOverlay(imgEl) {
  ...
  if (parent) { parent.insertBefore(imgEl, wrapper); parent.removeChild(wrapper); }
...
function removeLoader(loader) { loader?.remove(); }
